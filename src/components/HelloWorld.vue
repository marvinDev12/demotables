<template>
	<div id="loading-container" style="width:500px">
		<el-input style="width:250px" v-model="searchValue" placeholder="search name"></el-input>
		<el-button type="primary">Search</el-button>
		<br />
		<br />
		<ve-table :max-height="500" :virtual-scroll-option="virtualScrollOption"
				...
				setTimeout(() => {
					for (let i = 0; i < realPageSize; i++) {
						...
						const dataItem = {
							...
							name: "name" + index,
							hobby: "hobby" + index,
							address: "addresssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss" + index,
						};
						//
						if (index < totalCount) {
